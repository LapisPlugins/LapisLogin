...
public class ChangePasswordEvent extends Event implements Cancellable {
    ...
    /**
     * @return Returns the password the player is attempting to change from
     */
    ...
    /**
     * @return Returns the password the player is attempting to change to
     */
